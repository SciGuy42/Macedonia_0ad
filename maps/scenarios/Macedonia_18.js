...
Trigger.prototype.GarrisonEntities = function(data)
{
	...
	for (let p of [1,2,4,5])
	{
		...
		if (p == 2)
		{
			...
			{
				//spawn the garrison inside the tower
				let archers_e = TriggerHelper.SpawnUnits(e, "units/pers/champion_infantry",4,p);
...
Trigger.prototype.SpawnIntervalPatrol = function(data)
{
	...
	if (units.length < this.maxPatrolSize)
	{
		...
		let inf_templates = ["units/pers/champion_infantry","units/pers/champion_infantry","units/pers/champion_infantry","units/pers/champion_infantry","units/pers/infantry_archer_e","units/pers/infantry_javelineer_e","units/pers/infantry_javelineer_e","units/pers/infantry_spearman_e","units/pers/infantry_spearman_e","units/pers/champion_elephant"];
...
Trigger.prototype.SpawnFanaticSquad = function(data)
{
	...
	//structures
	let spwan_sites = TriggerHelper.MatchEntitiesByClass( TriggerHelper.GetEntitiesByPlayer(4), "Fortress").filter(TriggerHelper.IsInWorld);
	
	if (spwan_sites.length == 0)
		return;
		
	let inf_templates = ["units/pers/champion_infantry","units/pers/infantry_spearman_a","units/pers/infantry_spearman_b","units/pers/infantry_spearman_e","units/pers/infantry_archer_a","units/pers/infantry_javelineer_a"];
...
{
	//defense towers
	let towers_p = TriggerHelper.MatchEntitiesByClass( TriggerHelper.GetEntitiesByPlayer(2), "StoneTower").filter(TriggerHelper.IsInWorld);
...
{
	//defense towers
	let towers_p = TriggerHelper.MatchEntitiesByClass( TriggerHelper.GetEntitiesByPlayer(1), "StoneTower").filter(TriggerHelper.IsInWorld);
...
Trigger.prototype.SpawnCavalryAttack = function(data)
{
	...
	//types
	let cav_templates = ["units/pers/cavalry_archer_a","units/pers/cavalry_javelineer_a", "units/pers/cavalry_spearman_a", "units/pers/cavalry_axeman_a","units/pers/champion_cavalry", "units/pers/champion_cavalry_archer"];
	let attackers = [];
