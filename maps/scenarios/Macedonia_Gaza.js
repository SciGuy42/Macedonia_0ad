...
Trigger.prototype.GarrisonEntities = function(data)
{
	...
	for (const p of [1, 2, 4, 5])
	{
		...
		if (p == 2)
		{
			...
			{
				// spawn the garrison inside the tower
				const archers_e = TriggerHelper.SpawnUnits(e, "units/pers/champion_infantry", 2, p);
...
Trigger.prototype.SpawnFanaticSquad = function(data)
{
	...
	// structures
	const spwan_sites = TriggerHelper.MatchEntitiesByClass(TriggerHelper.GetEntitiesByPlayer(4), "Structure").filter(TriggerHelper.IsInWorld);
